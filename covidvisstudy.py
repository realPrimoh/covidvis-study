...
#        st.write("Leave blank (slider at -1) if you do not think restaurants/bars/other establishments were closed at any point in the graph. ")
    ...
    unsafe_allow_html=True
        ...
        if start < 0 or end < 0 or start > 170 or end > 170:
            st.warning("You have chosen to leave one or both of the slider options blank. This means you do not think restaurants/bars/other establishments were closed at any point in the graph. Please confirm this is your choice before moving on.")
